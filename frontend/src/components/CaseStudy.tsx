...
export default function CaseStudy() {
  return <main className="case-study">
    ...
    <section className="case-hero dark-surface">
      ...
      <p>Aizen turns an ambiguous Dubai home request into confirmed criteria, deterministic fit evidence, and a printable decision dossier.</p>
    </section>
    <section className="case-section"><p className="eyebrow">Product thesis</p><h2>Buyer confidence comes from visible evidence—not a persuasive score.</h2><p>The model interprets and explains. Pydantic validates. Local code filters, scores, audits, and calculates. Historical transactions stay context; captured listings stay inventory.</p></section>
    ...
    <section className="case-grid"><article><p className="eyebrow">Truth</p><h3>Frozen snapshot</h3><p>Every shown home carries a captured source, observed date, and snapshot identity. Unverified unit size and dedicated parking are deliberately withheld.</p></article><article><p className="eyebrow">Decisioning</p><h3>Deterministic fit</h3><p>Hard conflicts exclude, unknown must-haves become conditional, and unsupported wishes never inflate arithmetic.</p></article><article><p className="eyebrow">Evaluation</p><h3>Release-gated proof</h3><p>Python, component, browser, Compose, accessibility, mobile, and print gates are documented from verified commands.</p></article></section>
