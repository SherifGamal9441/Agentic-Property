...
class ActiveSearchTool:
    async def search(
        ...
        """
        Search active properties by calling the data-service API.
        All parameters are optional; omitted parameters are not sent.
        Date filters are not allowed for active listings.
        """
        ...
        url = f"{DATA_SERVICE_URL}/search/active"
